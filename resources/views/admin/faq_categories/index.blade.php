        ...
        <div class="row">
            <div class="col-12">
                <div class="card-body">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{ route('admin.faq_category.index') }}" method="GET">
                                <div class="row align-items-end">
                                    <!-- Search Input -->
                                    <div class="col-md-8 col-sm-12 mb-2">
                                        <label for="search">Search FAQ Category</label>
                                        <input type="search" class="form-control" id="search" name="search"
                                            placeholder="Search FAQ Category..." value="{{ request('search') }}">
                                    </div>
                                    ...
                                    <div class="col-md-2 col-sm-6 mb-2 text-md-right">
                                        <a href="{{ route('admin.faq_category.create') }}" class="btn btn-success w-100">
                                            <i class="fas fa-plus-circle"></i> Add FAQ Category
                                        </a>
                                    </div>
                                </div>
                            </form>
