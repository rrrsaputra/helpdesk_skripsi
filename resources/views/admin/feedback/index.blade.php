        ...
        ->map(function ($feedback) {
            return [
                ...
                'values' => [
                    ...
                    $feedback->attachments->isNotEmpty() ? '<span class="attachment-link" data-id="' . $feedback->id . '" onmouseover="this.style.cursor=\'pointer\'"><i class="fas fa-paperclip"></i> View Attachments</span>' : '',
                ...
                <div class="card-body">
                    <div class="form-group">
                        <form action="{{ route('admin.feedback.index') }}" method="GET" class="form-inline">
                            <div class="form-group">
                                <input type="search" class="form-control" id="search" name="search" style="width: 500px;" placeholder="Search by category, subject, and message">
                            </div>
                    ...
                    <div class="table-responsive">
                        <table id="example2" class="table table-hover">
                            ...
                            <tbody>
                                @forelse ($data as $row)
                                    <tr style="cursor: pointer" data-id="{{ $row['id'] }}" onclick="showMessagePopup('{{ addslashes($row['values'][3]) }}')">
