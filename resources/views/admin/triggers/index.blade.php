            ...
            <div class="col-12">
                <div class="card-body">
                    <div class="form-group">
                        <form action="{{ route('admin.triggers.index') }}" method="GET" class="form-inline">
                            <div class="form-group">
                                <input type="search" class="form-control" id="search" name="search"
                                    style="width: 500px;" placeholder="Search by name">
                            </div>
                            <button type="submit" class="btn btn-primary">Search</button>
                        </form>
                    </div>

                    <a href="{{ route('admin.triggers.create') }}" class="btn btn-primary mb-3">Add Trigger</a>
                    ...
                    <div class="table-responsive">
                        <table id="example2" class="table table-hover">
                            ...
                            <tbody>
                                @forelse ($data as $row)
                                    <tr style="cursor: pointer" data-id="{{ $row['id'] }}">
                                        ...
                                        <td> <!-- Added Actions buttons -->
                                            <a href="{{ route('admin.triggers.edit', $row['id']) }}"
                                                class="btn btn-sm btn-primary">Edit</a>

                                            <form action="{{ route('admin.triggers.destroy', $row['id']) }}" method="POST"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3">No triggers available</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
