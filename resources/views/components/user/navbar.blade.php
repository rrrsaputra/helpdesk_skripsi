    ...
    <div class="container">
        ...
        <div class="dx-navbar-content">
            <ul class="dx-nav " >
                    ...
                    <li><a href="/ticket"  style="color: white; transition: color 0.3s;"onmouseover="this.style.color='grey'" onmouseout="this.style.color='white'" >Ticket System</a></li>
                    <li><a href="/article"  style="color: white; transition: color 0.3s;"onmouseover="this.style.color='grey'" onmouseout="this.style.color='white'" >Articles</a></li>
