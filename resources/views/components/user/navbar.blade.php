                    ...
                    <ul class="dx-navbar-dropdown">
                        ...
                        <li class="dx-nav-item dx-nav-item-drop">
                            ...
                            <ul class="dx-navbar-dropdown">
                                ...
                                <li>
                                    <a class="dx-nav-link" href="single-article-category.html"> Single Article Category
                                    </a>
                                </li>
                                <li>
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row" class="dx-table-checkout-img">
                                        <a href="product.html"><img src="assets/images/product-1-sm.png"
                                                alt=""></a>
                                    </th>
                                ...
                                <tr>
                                    <th scope="row" class="dx-table-checkout-img">
                                        <a href="product.html"><img src="assets/images/product-2-sm.png"
                                                alt=""></a>
                                    </th>
                                    <td class="dx-table-checkout-title">
