                        ...
                        <table id="example2" class="table table-hover">
                            ...
                            <tbody>
                                @forelse ($data as $row)
                                    ...
                                    <!-- Modal -->
                                    <form method="POST" action="{{ route('agent.scheduled_call.update', $row['id']) }}">
                                        @csrf
                                        @method('PATCH')
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="assignToModalLabel{{ $row['id'] }}">
                                                            Add Meet</h5>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="duration{{ $row['id'] }}"
                                                                name="duration">
